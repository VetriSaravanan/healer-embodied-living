...
const VideoSection = () => {
  ...
  return <section className="healer-section relative overflow-hidden bg-gradient-to-br from-lavender/20 via-background to-secondary/30">
      {/* Decorative elements */}
      ...
      <div ref={ref} className={cn("healer-container relative z-10", isVisible ? "animate-fade-in-slow" : "opacity-0")}>
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight italic text-foreground">How Astralbeat Works<br />
              You Were Born<br />
              to Live
            </h2>
            
            <div className="space-y-2">
              <p className="text-xl md:text-2xl font-semibold text-foreground">Enhance Every Area of Your Life from Mind to Body & Soul</p>
              <p className="text-xl md:text-2xl font-semibold text-foreground">Daily 20mins lessons from life coaches to transform your life</p>
            </div>

            <a href="https://form.typeform.com/to/Uujm1fxF" target="_blank" rel="noopener noreferrer">
              <Button variant="hero" size="xl" className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 shadow-lg shadow-orange-500/30">
                Become a member
              </Button>
            </a>
          </div>
          ...
          <div className="relative flex items-center justify-center">
            ...
            <div className="absolute top-1/4 -left-8 w-16 h-16 bg-gradient-to-br from-violet/30 to-cyan-soft/30 rounded-full blur-sm opacity-60" style={{
            animationDelay: '-2s'
          }} />
            <div className="absolute -bottom-4 right-1/4 w-24 h-24 bg-gradient-to-br from-lavender/50 to-violet/30 rounded-full blur-sm opacity-50 animate-float" style={{
            animationDelay: '-4s'
          }} />
            ...
            <div className="relative">
              ...
              <div className="relative w-72 h-72 md:w-96 md:h-96 rounded-full overflow-hidden shadow-glow border-4 border-white/30">
                <video src={purposeVideo} autoPlay loop muted playsInline className="w-full h-full object-cover" />
